...
def partyPlacement():
    for x in range(len(ParlimentMembers)):
        ...
        elif partyCalc(x,20,70,10,50,30,60): ConservativeParty.append(ParlimentMembers[x])
        ...
        elif partyCalc(x,20,80,50,70,50,80): LabourParty.append(ParlimentMembers[x])
